 ...
 */
HarvardApp.controller('MainCtrl', ['$scope', '$timeout', '$log', '$modal', 'ganttUtils', 'GanttObjectModel', 'Coloured', 'Harvard', 'ganttMouseOffset', 'ganttDebounce', 'moment', function($scope, $timeout, $log, $modal, utils, ObjectModel, Coloured, Harvard, mouseOffset, debounce, moment) {
    var objectModel;
    var dataToRemove;
    ...
    for (var i = 0; i <= 5; i += 1) {
        $scope.itemsList.items.push({'Id': i, 'Label': 'Item ' + i});
    }
